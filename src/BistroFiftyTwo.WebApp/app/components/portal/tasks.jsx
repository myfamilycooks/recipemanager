      ...
      <div className="card-deck">
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p className="card-text">
              Create a new recipe or make a new version of an existing one.
            </p>
            <Link to={`${match.url}/recipe/editor`} className="btn btn-primary">
              Launch Recipe Builder
            </Link>
          </div>
        </div>
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p className="card-text">
              Browse your recipes by category. Manage Recipe your recipes.
            </p>
        ...
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p className="card-text">
              Search Recipes, both yours and other public recipes. Use the
