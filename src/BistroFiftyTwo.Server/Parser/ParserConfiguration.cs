...
namespace BistroFiftyTwo.Server.Parser
{
    public class ParserConfiguration
    {
        ...
        public Dictionary<string, List<string>> MeasurementUnits { get; set; } = new Dictionary<string, List<string>>
        {
            ...
            {
                "tablespoon",
                new List<string> {"tablespoon", "tbl", "tbs", "tbsp", "tablespoons", "tablespoon(s)", "tbsp(s)"}
            },
        ...
        public List<string> IngredientQualifiers { get; set; } =
            new List<string> {"diced", "large", "small", "medium", "finely", "halved"};
