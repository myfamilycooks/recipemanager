...
namespace BistroFiftyTwo.Cli
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if(!commandFound) 
                Console.WriteLine(@"Usage: bistrofiftytwo.cli -h http://localhost:60679 -u youruser -p yourpass -a import -f 'C:\source\github\myfamilycooks\recipemanager\samples' --pattern *.txt");
