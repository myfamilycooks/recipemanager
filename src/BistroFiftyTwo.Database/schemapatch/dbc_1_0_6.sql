...
begin
	...
	if (_patch_required > 0) then
		...
		alter table client_allowedgranttypes rename allowedgranttype to granttype;
		alter table clients rename alwayssetndclientclaims to alwayssendclientclaims;
		alter table client_postlogoutredirecturls rename postlogoutredirecturl to url;
		alter table client_redirecturls rename redirecturl to url;
