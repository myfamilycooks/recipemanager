...
namespace BistroFiftyTwo.Tests.Parser
{
    ...
    {
        [Fact]
        [Trait("Ingredient Parser", "When parsing an ingredient with a complex fractional quantity and complex notes")]
        ...
        [Fact]
        [Trait("Ingredient Parser", "When parsing a properly formed ingredient")]
        ...
        [Fact]
        [Trait("Ingredient Parser", "When parsing an ingredient with a complex fractional quantity")]
        ...
        [Fact]
        [Trait("Ingredient Parser", "When parsing an ingredient with a fractional quantity")]
        ...
        [Fact]
        [Trait("Ingredient Parser", "When parsing an ingredient with noise words")]
        ...
        [Fact]
        [Trait("Ingredient Parser", "When parsing an ingredient with plural units")]
