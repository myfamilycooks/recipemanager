...
namespace BistroFiftyTwo.Tests.Parser
{
    ...
    {
        [Fact]
        [Trait("Parser Tests", "When parsing an empty recipe")]
        ...
        [Fact]
        [Trait("Parser Tests", "When Parsing a full recipe")]
...
";
        ...
        [Fact]
        [Trait("Parser Tests", "When Parsing a recipe with no description")]
...
";
            ...
            Assert.Matches(parseError.ToString(),
                output.Errors.Single(c => c.ErrorCode == ParseErrorCode.NoDescription).ToString());
        }

        [Fact]
        [Trait("Parser Tests", "When Parsing a recipe with no ingredients")]
...
";
            ...
            Assert.NotEmpty(output.Errors);
            Assert.Matches(parseError.ToString(),
                output.Errors.Single(c => c.ErrorCode == ParseErrorCode.NoIngredients).ToString());
        }

        [Fact]
        [Trait("Parser Tests", "When Parsing a recipe with no instructions")]
...
";
        ...
        [Fact]
        [Trait("Parser Tests", "When Parsing a recipe with proper sections")]
